...
class LoadingButton @JvmOverloads constructor(
    ...
    private val DOWNLOADING = context.getString(R.string.button_download)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        when (buttonState) {
            ButtonState.Clicked -> {
                println("isClickable $isClickable")
                showRect = true
                showCircle = true
            }
            ButtonState.Loading -> {
                currText = ( if(isClickable) { LOADING } else DOWNLOADING)
                showRect = isClickable
                showCircle = isClickable
            }
